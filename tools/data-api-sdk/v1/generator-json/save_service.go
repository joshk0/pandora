...
import (
	...
	"github.com/hashicorp/pandora/tools/data-api-sdk/v1/generator-json/stages"
...
type SaveServiceOptions struct {
	...
	// SourceDataGitSHA specifies the Git Commit SHA that these API Definitions were imported from.
	SourceDataGitSHA *string
}
...
func (r repositoryImpl) SaveService(opts SaveServiceOptions) error {
	...
	items := []stages.Stage{
		stages.MetaDataStage{
			GitRevision:      opts.SourceDataGitSHA,
